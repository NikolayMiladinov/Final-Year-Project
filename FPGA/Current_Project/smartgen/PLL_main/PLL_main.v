...
output GLA;
    ...
    PLL #( .VCOFREQUENCY(60.000) )  Core (.CLKA(CLKA), .EXTFB(GND), 
        .POWERDOWN(POWERDOWN), .GLA(GLA), .LOCK(LOCK), .GLB(), .YB(), 
        .GLC(), .YC(), .OADIV0(GND), .OADIV1(GND), .OADIV2(VCC), 
...
// MGNTIMER:F
// MGNCMPL:T
// DESDIR:C:/Users/nikol/Documents/FinalYearProject/Final-Year-Project/FPGA/Current_Project/smartgen\PLL_main
// GEN_BEHV_MODULE:F
